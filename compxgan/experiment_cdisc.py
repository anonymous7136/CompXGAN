...
from compxgan.discriminators import cMultiResolutionDiscriminator
...
from compxgan.experiment import CompXGANExp
from compxgan.loss import cFeatureMatchingLoss, cGeneratorLoss, cDiscriminatorLoss


class CompXGANExp(CompXGANExp):
    def __init__(
        self,
